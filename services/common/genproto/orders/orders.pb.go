...
const file_orders_proto_rawDesc = "" +
	...
	"\bQuantity\x18\x04 \x01(\x05R\bQuantity2J\n" +
	"\fOrderService\x12:\n" +
	"\vCreateOrder\x12\x13.CreateOrderRequest\x1a\x14.CreateOrderResponse\"\x00B-Z+github.com/airlangga-hub/grpc/common/ordersb\x06proto3"
...
var file_orders_proto_depIdxs = []int32{
	4, // 0: GetOrdersResponse.orders:type_name -> Order
